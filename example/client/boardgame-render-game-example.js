...
class BoardgameRenderGameExample extends BoardgameBaseGameRenderer {
...
`;
  ...
  static get is() {
    return "boardgame-render-game-example"
  }
...
customElements.define(BoardgameRenderGameExample.is, BoardgameRenderGameExample);
